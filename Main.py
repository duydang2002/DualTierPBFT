...
if p.model == 3:
    ...
    from Models.DualTierBlockchain.Consensus import Consensus
    ...
    from Models.DualTierBlockchain.Incentives import Incentives
...
def main():
    for i in range(p.Runs):
        ...
        Statistics.chain = p.NODES[1].blockchain.copy()  
        Statistics.calculate()
        Statistics.print_to_excel("test.xlsx")
